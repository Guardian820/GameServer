...
namespace LeagueSandbox.GameServer.Logic.GameObjects
{
    public class Champion : ObjAIBase
    {
        ...
        public override void UpdateReplication()
        {
            ...
            ReplicationManager.Update(Stats.ManaCost[0], 0, 8);
            ReplicationManager.Update(Stats.ManaCost[1], 0, 9);
            ReplicationManager.Update(Stats.ManaCost[2], 0, 10);
            ReplicationManager.Update(Stats.ManaCost[3], 0, 11);
            ReplicationManager.Update(Stats.ManaCostEx[0], 0, 12);
            ReplicationManager.Update(Stats.ManaCostEx[1], 0, 13);
            ReplicationManager.Update(Stats.ManaCostEx[2], 0, 14);
            ReplicationManager.Update(Stats.ManaCostEx[3], 0, 15);
            ReplicationManager.Update(Stats.ManaCostEx[4], 0, 16);
            ReplicationManager.Update(Stats.ManaCostEx[5], 0, 17);
            ReplicationManager.Update(Stats.ManaCostEx[6], 0, 18);
            ReplicationManager.Update(Stats.ManaCostEx[7], 0, 19);
            ReplicationManager.Update(Stats.ManaCostEx[8], 0, 20);
            ReplicationManager.Update(Stats.ManaCostEx[9], 0, 21);
            ReplicationManager.Update(Stats.ManaCostEx[10], 0, 22);
            ReplicationManager.Update(Stats.ManaCostEx[11], 0, 23);
            ReplicationManager.Update(Stats.ManaCostEx[12], 0, 24);
            ReplicationManager.Update(Stats.ManaCostEx[13], 0, 25);
            ReplicationManager.Update(Stats.ManaCostEx[14], 0, 26);
            ReplicationManager.Update(Stats.ManaCostEx[15], 0, 27);
